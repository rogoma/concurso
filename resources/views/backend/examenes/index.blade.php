	...
	<div class="col-12">
        ...
        @if(session('perfil') == true && session('ci'))
            <div class="card-header bg-info">
                <h5 class="text-white float-left">Listado de Exámenes de Concursos MSPyBS</h5>
                <a href="{{route('examen.create')}}" class="btn btn-outline-light btn-sm float-right"><i class="fas fa-plus"></i> Crear</a>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered" id="data-table">
                        ...
                        <tbody>
                            @include('backend.examenes.data-table')
                        </tbody>
                        <tfoot>
                            <tr>
                                <th>ID</th>
