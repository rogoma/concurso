		...
		<div class="card">
            ...
            <div class="card-body">
                ...
                <span class="float-right">
                    ...
                    <input type="radio" id="noAll" name="All" value="0" onclick="selectAll(matriz); putRequiredAll();"/>
                </span>
                <div class="table-responsive row">
                    <form action="{{ route('documental.update') }}" method="POST" name="matriz" class="form-horizontal" id="form-horizontal">
                    @csrf @method('put')
                    ...
                    <input type="hidden" name="postulacion_id" value="{{ $datos->postulacion->id }}">
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                @if($datos->concurso->matrizdocs !== null)
                                    @include('frontend.validar.documental.data-table-edit')
                                @endif
                            </tbody>
                            <tfoot>
                                <tr>
