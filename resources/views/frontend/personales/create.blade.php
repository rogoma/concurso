	...
	<div class="col-md-12">
		<div class="card">
            ...
            <div class="card-header bg-success">
                <h4 class="card-title text-white">Crear Dato Personal</h4>
            </div>
			<form action="{{route('personales')}}" id="form-general" class="form-horizontal" method="POST" enctype="multipart/form-data" autocomplete="off">
				@csrf
