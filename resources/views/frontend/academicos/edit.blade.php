...
@section('scripts')
<script src="{{asset("assets/concursos/pages/academicos/crear.js")}}"></script>
@endsection
	...
	<div class="col-md-12">
		<div class="card">
            ...
            <div class="card-header bg-success">
                <h4 class="card-title text-white">Editar Dato Académico</h4>
            </div>
            <form
                action="{{route('academicos.update', $data->academico->id)}}"
            ...
            >
                ...
                @include('frontend.academicos.form')
                <div class="border-top">
                    <div class="card-body">
                        <button type="submit" class="btn btn-success">Guardar</button>
                        <button type="reset" class="btn btn-info" onclick="location.href='{{route('academicos')}}'">Regresar</button>
                    </div>
                </div>
            </form>
            @else
